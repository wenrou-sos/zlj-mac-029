...
async function main() {
  ...
  const cards = [
    ...
    {
      card_no: 'WC-2026-0911', aircraft: 'B-5301', title: '客舱 12ABC 座椅靠背调节失效（重复报卡）',
      type: '航线维修', priority: '正常', status: '已作废',
      due: '2026-09-18', desc: '乘务员重复提交的故障报告。',
      steps: [
        ['检查座椅靠背调节钢索及作动机构', 'AMM 25-21-00', 0],
        ['视情更换调节作动筒', 'AMM 25-21-00', 0],
      ],
  ...
  const logs = [
    ...
    ['WC-2026-0911', '生产控制-郑海', '创建工卡', '乘务员报告座椅故障'],
    ['WC-2026-0911', '生产控制-郑海', '作废', '作废原因：重复报卡，与 WC-2026-0903 为同一故障'],
  ];
